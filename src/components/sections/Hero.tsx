          ...
          <div className="relative -mt-20 h-[460px] w-full max-w-[1120px] sm:-mt-24 sm:h-[580px] md:-mt-36 md:h-[690px]">
            ...
            >
              ...
              <motion.div
                ...
                className="absolute left-1/2 top-[46%] z-10 h-[480px] w-[480px] -translate-x-1/2 -translate-y-1/2 sm:h-[580px] sm:w-[580px] md:left-[54%] md:h-[750px] md:w-[750px]"
              >
                <Image
            ...
            {stageLabels.map((label, index) => {
              ...
              return (
                <motion.span
                  ...
                  className={`animate-float-tag absolute hidden rounded-full border border-white/[0.12] bg-white/[0.07] px-4 py-2 text-[11px] font-mono uppercase tracking-[0.22em] text-white/62 shadow-[0_18px_60px_rgba(0,0,0,0.32)] backdrop-blur-xl md:block ${positions[index]}`}

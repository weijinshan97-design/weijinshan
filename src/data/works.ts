...
export const worksData: Work[] = [
  {
    ...
    category: "AI 产品设计",
    year: "2024 — 2026",
    cover: "/images/works/WBITFM新.png",
    summaryZh:
    ...
    images: Array.from({ length: 17 }, (_, i) => `/images/works/wbit/${i + 1}.png`),
  ...
  },
  {
    ...
    category: "品牌设计",
    year: "2021 — 2023",
    cover: "/images/works/滴滴代驾会员新.png",
    summaryZh:
